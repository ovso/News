...
public class ListUpActivityModule {
  ...
  @Singleton
  @Provides
  public RecyclerView.Adapter provideWrapperAdapter(RecyclerViewDragDropManager dragDropManager,
  ...
  public ItemShadowDecorator provideItemShadowDecorator(Context context) {
    return new ItemShadowDecorator(
        (NinePatchDrawable) ContextCompat.getDrawable(context, R.drawable.material_shadow_z1));
  }

  @Singleton
  @Provides
  public SimpleListDividerDecorator provideSimpleListDividerDecorator(Context context) {
    return new SimpleListDividerDecorator(
