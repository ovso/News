package io.github.ovso.news.search.customview;
...
public class SearchEditText extends AppCompatEditText
  ...
  private void initSearch() {
    Drawable tempDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_search);
    searchDrawable = DrawableCompat.wrap(tempDrawable);
    DrawableCompat.setTintList(clearDrawable, getHintTextColors());
    searchDrawable.setBounds(0, 0, clearDrawable.getIntrinsicWidth(),
